...
public static class ContextsExtensions {
    ...
    public static GameEntity GetEntityWithId(this GameContext context, string id) {
        return ((Entitas.PrimaryEntityIndex<GameEntity, string>)context.GetEntityIndex(Contexts.Id)).GetEntity(id);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
