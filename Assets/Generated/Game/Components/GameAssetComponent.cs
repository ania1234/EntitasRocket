...
public partial class GameEntity {
    ...
    public void AddAsset(string newAssetKey, bool newIsLoading) {
        var index = GameComponentsLookup.Asset;
        var component = (AssetComponent)CreateComponent(index, typeof(AssetComponent));
        component.assetKey = newAssetKey;
        component.isLoading = newIsLoading;
        AddComponent(index, component);
    }

    public void ReplaceAsset(string newAssetKey, bool newIsLoading) {
        var index = GameComponentsLookup.Asset;
        var component = (AssetComponent)CreateComponent(index, typeof(AssetComponent));
        component.assetKey = newAssetKey;
        component.isLoading = newIsLoading;
